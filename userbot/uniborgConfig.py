...
if ENV:
    ...
    class Config(object):
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "AbradereUserbot")
        ...
        #
        # Non modificare il valore 4095 
        # TG API non supporta altri valori!
        MAX_MESSAGE_SIZE_LIMIT = 4095
        UB_BLACK_LIST_CHAT = set(int(x) for x in os.environ.get("UB_BLACK_LIST_CHAT", "").split())
        # Numero massimo di messagi, prima che intervenga antiflood
