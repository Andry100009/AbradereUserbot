...
IS_SELECTED_DIFFERENT_BRANCH = (
    ...
    "viene usato:\n"
    "in questo caso, Updater non è in grado di identificare il file da aggiornare."
...
NO_HEROKU_APP_CFGD = "nessuna applicazione heroku trovata 😕 "
HEROKU_GIT_REF_SPEC = "HEAD:refs/heads/master"
RESTARTING_APP = "Riavvia heroku application"
        ...
        if len(heroku_applications) >= 1:
            if Var.HEROKU_APP_NAME is not None:
                ...
                if heroku_app is None:
                    await message.edit('**Errore APP Name. Inserisci il nome del bot nella Var `HEROKU_APP_NAME.**')
                    return
