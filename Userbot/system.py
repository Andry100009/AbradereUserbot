    ...
    def decorator(func):
        async def wrapper(check):
            ...
            if groups_only and not check.is_group:
                await check.respond("`Ma ti sembra un gruppo?`")
                return            
            try:
                await func(check)
                ...
                if not disable_errors:
                    ...
                    text = "**AbraderUserbot ERROR REPORT**\n"
                    text += "Mostra il file a @Abradere se non sai risolvere\n"

                    ftext = "========== ATTENZIONE =========="
                    ftext += "\nFile inoltrato nella LOG CHAT,"                
                    ...
                    file = open("AbradereUserbot_error.log", "w+")
                    file.write(ftext)
                    file.close()
                    ...
                    await check.client.send_file(send_to,
                                                 "AbradereUserbot_error.log",
                                                 caption=text)
                    remove("AbradereUserbot_error.log")
            else:
                pass
