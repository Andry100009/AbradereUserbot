...
if len(argv) not in (1, 3, 4):
    ...
    if Var.TG_BOT_USER_NAME_BF_HER is not None:
        ...
        print("Avvio Bot completato senza errori")
        print("Avvio Userbot")
...
print("AbradereUserbot avviato correttamente, test con .prova")
print("Gruppo Affiliato per support Userbot @bambineditiktok")
