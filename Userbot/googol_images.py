...
class googleimagesdownload:
    ...
    def download_extended_page(self,url,chromedriver):
        ...
        browser.get(url)
        time.sleep(1)
        print("Ti sto procurando molte immagini. L'operazione potrebbe richiedere alcuni minuti ...")
    ...
    def similar_images(self,similar_images):
        ...
        if cur_version >= version: 
            ...
            try:
                ...
                return "Non riesco a connettermi a google"
    ...
    def keywords_from_file(self,file_name):
        ...
        with codecs.open(file_name, 'r', encoding='utf-8-sig') as f:
            if '.csv' in file_name:
                ...
                print("File caricato non valido, .txt o .csv \n"
                      "esco...")
                sys.exit()
    ...
    def download_executor(self,arguments):
        ...
        if arguments['single_image'] is None and arguments['url'] is None and arguments['similar_images'] is None and \
            ...
            print('-------------------------------\n'
                  'Attenzione, Le parole chiave sono fondamentali \n\n'
                  'Usa questo sito di riferimento, per evitare di fare erroris \n'
